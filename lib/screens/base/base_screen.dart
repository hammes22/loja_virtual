  ...
  void configFCM() {
    ...
    fcm.configure(
      ...
      onMessage: (Map<String, dynamic> message) async {
        showNotification(
          message['notiification']['title'] as String,
          message['notiification']['body'] as String,
        );
      },
    );
  }
        ...
        child: Consumer<UserManager>(
          builder: (_, userManager, __) {
            return PageView(
              ...
              // impede de arrastar a PageView através de gestos
              ...
              children: <Widget>[
                ...
                if (userManager.adminEnabled) ...[
                  //tela mostrando todos os usuarios cadastrados.
                  AdminUserScreen(),
                  //tela mostrando todos os pedidos.
                  AdminOrdersScreen(),
                ]
              ],
            );
